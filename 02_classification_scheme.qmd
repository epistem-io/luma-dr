...
Bug: add_class() allows duplicate IDs in edit mode.

It only check duplicate ID when not self.edit_mode. → User can create two classes with same ID by editing one and changing its ID to an existing one.
:::
