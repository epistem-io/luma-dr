...
2.  The user is prompted to choose how to add sample data, either by [uploading their own dataset](#sec-user-upload-their-own-training-data), using [on-screen sampling](#sec-on-screen-sampling), or using [default sample data](@sec-default-sample-data) .
...
2.  The user is prompted to specify the column header that specify the LULC class. 
    This is a part of **User Journey 3.2a: Uploading sample data**

**Luma Geospatial Engine**

1.  The system verifies the format data input of the `.shp` inside the `.zip` . 
    This is a part of **System Response 3.2.a: Verifying the uploaded sample data format**
...
5.  The system provides an option to move to [on-screen sampling](#sec-on-screen-sampling) to add more sample data. This is a part of **User Journey 3.2.b: Choosing to add new sample data for insufficient class**
...
5.  The system then moves to @sec-sample-data-preview.
...
3.  The user is given the option to proceed to @sec-module-4 .
...
1.  The system runs @sec-verify-sample-data for the **updated** sample data.
    ...
    Visio diagram and source code needs to be updated to move sample data splitting to Module 6. It is currently still in Module 3.
    :::
