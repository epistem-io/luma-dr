...
When the user [chose to use default classification scheme](@user-select-existing-lulc-template), @sample-data-feature-extraction and @sec-create-classification-model are skipped.

1.  The system loads the [pre-generated probability map](@produce-prob-maps) stack and clips it to the user's AOI.
