...
The user is shown the map generated on the map canvas with the classes in different colours, and the panel is showing map accuracy results, LULC class composition, and map’s thematic accuracy assessment process.