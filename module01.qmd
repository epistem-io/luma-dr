...
Add options to upload kml/ kmz files for non-gis users.
:::
...
1.   The user select an AOI based on a drop down list of Indonesian regency administrative boundaries

2.  The system provide a preview of the selected boundary

**Luma Geospatial Engine**

1.  Load `ee.FeatureCollection` containing Indonesian administrative boundaries. The data should be uploaded as GEE asset and the link for it must be provided and shared publicly
2.  The system extract the regency name and provide complete list for the user
