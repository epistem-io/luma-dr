...
No spatial train/test split, severe spatial autocorrelation → Both random and stratified splits ignore spatial proximity → training and validation pixels can be meters apart → overoptimistic accuracy (often \>15–30% inflated OA/Kappa). Example: <https://code.earthengine.google.com/1b71681b94be875fedb86a0ebed6c532>
:::
...
1.  The user is given the option to manually configure the classification parameter:
